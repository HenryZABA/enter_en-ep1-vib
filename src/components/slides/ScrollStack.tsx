...
export const ScrollStackItem: React.FC<ScrollStackItemProps> = ({ children, itemClassName = '', itemStyle }) => (
  <div
    className={`scroll-stack-card relative w-full h-72 my-6 p-8 rounded-3xl shadow-2xl box-border origin-top will-change-transform ${itemClassName}`.trim()}
    style={{
...
export const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  return (
    ...
    >
      <div className="scroll-stack-inner pt-8 px-4 md:px-8 pb-96 min-h-full">
        {children}
